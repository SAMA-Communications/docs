...
For a more precise description and field constraints, see the **validations** dir in source code repo:
...
A complete list of all existing record fields can be found in the **models** dir in source code repo:
...
```json
{
  ...
  "body": "User3 has left the conversation",
  "attachments": [
    {
